"""Check simple-grid quantization fixtures against legacy Python."""
...
FIXTURE_PATH = REWRITE_ROOT / "fixtures" / "quantization_simple_grid_core.tsv"

sys.path.insert(0, str(PROJECT_ROOT))

from inference.quant.quantization import _quantize_notes_simple  # noqa: E402
...
def main() -> None:
    for line in FIXTURE_PATH.read_text().splitlines():
        ...
        _quantize_notes_simple(notes, float(tempo_raw), int(step_raw))
